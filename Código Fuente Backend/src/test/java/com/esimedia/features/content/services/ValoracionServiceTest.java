...
public class ValoracionServiceTest {
    ...
    void setUp() {
        ...
        valoracion = new ValoracionContenido(CONTENT_ID, USER_ID, 5);
    }
    ...
    void testValorarContenido_InvalidValoracionLow() {
        assertThrows(ResponseStatusException.class, () ->
            valoracionService.valorarContenido(CONTENT_ID, USER_ID, 0));
    }

    @Test
    void testValorarContenido_InvalidValoracionHigh() {
        assertThrows(ResponseStatusException.class, () ->
            valoracionService.valorarContenido(CONTENT_ID, USER_ID, 6));
    }
    ...
    void testValorarContenido_ContentNotFound() {
        ...
        assertThrows(ResponseStatusException.class, () ->
            valoracionService.valorarContenido(CONTENT_ID, USER_ID, 5));
    }
    ...
    void testValorarContenido_NewValoracion_Video() {
        ...
        valoracionService.valorarContenido(CONTENT_ID, USER_ID, 4);
    ...
    void testValorarContenido_UpdateExisting() {
        ValoracionContenido existing = new ValoracionContenido(CONTENT_ID, USER_ID, 3);
    ...
    void testActualizarValoracionMedia_Audio() {
        ValoracionContenido val1 = new ValoracionContenido(CONTENT_ID, "user1", 5);
        ValoracionContenido val2 = new ValoracionContenido(CONTENT_ID, "user2", 3);
    ...
    void testActualizarValoracionMedia_Video() {
        ValoracionContenido val1 = new ValoracionContenido(CONTENT_ID, "user1", 4);
        ...
        verify(videoRepository).save(argThat(v -> v.getValoracionMedia() > 0));
    }
    ...
    void testEliminarValoracionesDeUsuario_Audio() {
        ValoracionContenido val1 = new ValoracionContenido("content1", USER_ID, 5);
        ValoracionContenido val2 = new ValoracionContenido("content2", USER_ID, 4);
    ...
    void testEliminarValoracionesDeUsuario_Video() {
        ValoracionContenido val = new ValoracionContenido("content1", USER_ID, 5);
