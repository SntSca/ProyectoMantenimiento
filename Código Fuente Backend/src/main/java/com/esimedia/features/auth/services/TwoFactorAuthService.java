...
import com.esimedia.features.user_management.services.*;
...
public class TwoFactorAuthService {
    ...
    // ===== MÉTODOS HELPER PARA MANEJO DE USUARIOS =====
    
    /**
     * Busca un usuario por ID en los 3 repositorios
     */
    private Usuario findUsuarioById(String userId) {
        return userRetrievalService.findAnyUserById(userId)
