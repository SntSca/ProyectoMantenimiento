...
export const environment = {
  ...
  apiBaseUrl: true ? 'https://g07-esimedia-pi-backend-i1v8.onrender.com' : 'http://localhost:9090',
  ...
  // Endpoints de usuarios
    ...
    management: {
      user:{
        ...
        getUserGustos: '/users/me/gustos',
        updateUserGustos: '/users/me/gustos', //SI
        getExpiringAlerts: '/api/notifications/alerts' //SI
      },
      creator:{
