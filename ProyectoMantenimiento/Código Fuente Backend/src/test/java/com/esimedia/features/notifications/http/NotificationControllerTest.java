...
class NotificationControllerTest {
    ...
    void getInboxShouldCallServiceWithCurrentUser() {
        ...
        List<NotificationDTO> expectedList = List.of(
                new NotificationDTO("1", "NOTIFICATION", "NEW_CONTENT", "t", "b", Map.of(), false, "2025-01-01T10:00:00"),
                new NotificationDTO("2", "ALERT", "ALERT_GENERIC", "t2", "b2", Map.of(), true, "2025-01-02T10:00:00")
        );
    ...
    void getExpiringAlertsShouldFilterAlertsFromInbox() {
        ...
        NotificationDTO notif1 = new NotificationDTO(
                "1", "NOTIFICATION", "NEW_CONTENT", "t1", "b1", Map.of(), false, "2025-01-01T10:00:00"
        );
        NotificationDTO notif2 = new NotificationDTO(
                "2", "ALERT", "ALERT_GENERIC", "t2", "b2", Map.of("k", "v"), false, "2025-01-02T10:00:00"
        );
        NotificationDTO notif3 = new NotificationDTO(
                "3", "ALERT", "EXPIRING_SOON", "t3", "b3", Map.of(), false, "2025-01-03T10:00:00"
        );
