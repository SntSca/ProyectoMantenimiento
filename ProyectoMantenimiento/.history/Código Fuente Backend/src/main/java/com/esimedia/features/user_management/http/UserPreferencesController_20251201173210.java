...
public class UserPreferencesController {
    ...
    public ResponseEntity<Map<String, List<String>>> getGustos(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(Map.of("gustosTags", gustos));
    }
    ...
    public ResponseEntity<Map<String, List<String>>> updateGustos(
        ...
        String userId = getCurrentUserId(request);
        List<String> gustosTags = body.getOrDefault("gustosTags", List.of());
        ...
        return ResponseEntity.ok(Map.of("gustosTags", gustosTags));
    }
}
