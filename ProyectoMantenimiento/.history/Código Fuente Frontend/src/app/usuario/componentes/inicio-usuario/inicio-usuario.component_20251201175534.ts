...
// 1) NUEVA propiedad para controlar el menú lateral en móvil
isSidebarOpen: boolean = false;
// 2) NUEVO método para abrir/cerrar el sidebar
toggleSidebar(): void {
  this.isSidebarOpen = !this.isSidebarOpen;
}
// 3) NUEVO método para cerrar el sidebar sólo si estamos en móvil
