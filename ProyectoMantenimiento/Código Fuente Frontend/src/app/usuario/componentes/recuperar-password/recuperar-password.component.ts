...
@Component({
  selector: 'app-recuperar-password-usuario',
  standalone: true,
  imports: [RouterModule, ReactiveFormsModule, CommonModule],
  templateUrl: '../../../shared/components/recuperar-password/recuperar-password.component.html',

})
export class RecuperarPasswordUsuarioComponent implements OnInit {
  ...
  async onRecuperarPassword(): Promise<void> {
    ...
    try {
      await this.usuarioService.enviarCorreoRecuperacion(email);
      this.emailSent = true;
    } catch (error) {
