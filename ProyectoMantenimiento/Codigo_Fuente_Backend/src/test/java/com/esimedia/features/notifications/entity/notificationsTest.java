...
class NotificationTest {
    ...
    void testLombokDataGeneratedMethods() {
        ...
        // Create an identical object for equals/hashCode tests
        Notification n2 = new Notification();
        n2.setId("1");
        n2.setUserId("u1");
        n2.setType(NotificationType.NOTIFICATION);
        n2.setSubtype(NotificationSubtype.NEW_CONTENT);
        n2.setTitle("Titulo");
        n2.setBody("Body");
        n2.setPayload("{\"v\":1}");
        n2.setRead(true);
